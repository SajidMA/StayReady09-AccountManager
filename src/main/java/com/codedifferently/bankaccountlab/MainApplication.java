...
public class MainApplication {
    ...
    public static void main(String[] args) {
        ...
        CheckingAccount checkingAccount = new CheckingAccount(expectedAccountNumber, expectedFees, expectedBalance, expectedPassword2, expectedName);
    ...
    public static void createCheckingAccount() {
        ...
        CheckingAccount checkingAccount = new CheckingAccount(accountNumber, fees, balance, password, name);
    ...
    public static void createSavingsAccount() {
        ...
        SavingsAccount savingsAccount = new SavingsAccount(accountNumber, fees, balance, password, name, rates);
    ...
    public static void createBusinessAccount() {
        ...
        BusinessAccount businessAccount = new BusinessAccount(accountNumber, fees, balance, password, company, taxId);
    ...
    public static void depositIntoAccount() {
        ...
        accounts.get(currentAccountIndex).depositInBalance(depositAmt);
    ...
    public static void withdrawFromAccount() {
        ...
        //gets the most recent account in use, and deposits
        if (withdrawAmt > 0) {
            accounts.get(currentAccountIndex).withdrawFromBalance(withdrawAmt);
            System.out.println("Your new balance is: " + accounts.get(currentAccountIndex).getBalance());
        } else {
